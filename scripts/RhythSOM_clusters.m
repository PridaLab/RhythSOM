function [clusData, clussMap, varargout] = RhythSOM_clusters(sMap, BMUs, method, autoClus, numRep)
...
% Modified by LCN - E.F Rodríguez Sebastián 2019
    ...
    tmpclusCentroids = kmeans_clustersModified(sMap, method);
    ...
    parfor iRep = 1:numRep
        [tmpclusCentroids, tmpclusIndex, tmpclusError, tmpclusDBidx] = kmeans_clustersModified(sMap, method);
    ...
    varargout{2} = clusCentroids{clusNum,clusNumRep};
